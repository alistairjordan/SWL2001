...
MCU_FLAGS ?= -march=armv7-a -mfpu=neon -mfloat-abi=hard
...
#-----------------------------------------------------------------------------
BOARD_C_SOURCES = smtc_modem_hal/smtc_modem_hal.c \
	smtc_hal_linux/smtc_hal_eeprom.c\
	smtc_hal_linux/smtc_hal_rng.c\
	smtc_hal_linux/smtc_hal_spi.c\
	smtc_hal_linux/smtc_hal_trace.c\
	smtc_hal_linux/smtc_hal_uart.c\
	smtc_hal_linux/smtc_hal_watchdog.c \
	smtc_hal_linux/spidev_lib/spidev_lib.c \
	smtc_hal_linux/smtc_hal_lp_timer.c\
	smtc_hal_linux/smtc_hal_gpio.c\
	smtc_hal_linux/smtc_hal_rtc.c\
	smtc_hal_linux/smtc_hal_mcu.c
...
BOARD_C_INCLUDES =  \
	...
	-Ismtc_modem_hal\
	-Ismtc_hal_linux \
	-Ismtc_hal_linux/spidev_lib

#@echo $(BOARD_C_INCLUDES)
